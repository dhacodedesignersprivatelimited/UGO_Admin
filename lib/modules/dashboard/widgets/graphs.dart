...
class DashboardCarousel1 extends StatefulWidget {
  const DashboardCarousel1({super.key, required this.state});
...
class _DashboardCarousel1State extends State<DashboardCarousel1>
  ...
  final ValueNotifier<int?> _touchedPieIndex = ValueNotifier(null);
  ...
  void didUpdateWidget(covariant DashboardCarousel1 oldWidget) {
    ...
    final prev = oldWidget.state.chartRevision;
    final next = widget.state.chartRevision;
    if (prev != next && prev > 0) {
      _animController
        ..reset()
        ..forward();
              ...
              child: Column(
                children: [
                  ...
                  ValueListenableBuilder<int>(
                    ...
                    builder: (_, page, __) => _DotsIndicator(
                      count: 3,
                      index: page,
  ...
  Widget _earningsPage(DashboardState m) {
  ...
  Widget _ridesBarPage(DashboardState m) {
  ...
  Widget _piePage(DashboardState m) {
            ...
            Expanded(
              child: SizedBox(
                ...
                child: ValueListenableBuilder<int?>(
                  valueListenable: _touchedPieIndex,
                  builder: (_, touched, __) => PieChart(
                    PieChartData(
