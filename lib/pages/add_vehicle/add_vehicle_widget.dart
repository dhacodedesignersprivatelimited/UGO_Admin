...
class _AddVehicleWidgetState extends State<AddVehicleWidget> {
  ...
  void initState() {
    ...
    _model.priceperkmTextController ??= TextEditingController();
    _model.priceperkmFocusNode ??= FocusNode();
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  validator: _model
                                      .vehicleNameTextControllerValidator
                                      .asValidator(context),
                                ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.vehicleTypeTextController,
                                    focusNode: _model.vehicleTypeFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      hintText: 'Enter vehicl Type',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            font: GoogleFonts.inter(
                                    ...
                                    validator: _model
                                        .vehicleTypeTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ].divide(SizedBox(height: 8.0)),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller: _model.priceperkmTextController,
                                  focusNode: _model.priceperkmFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  validator: _model
                                      .priceperkmTextControllerValidator
                                      .asValidator(context),
                                ),
                              ].divide(SizedBox(height: 8.0)),
                            ),
                            Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller:
                                      _model.seatingCapacityTextController,
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller:
                                      _model.luggageCapacityTextController,
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    if (_model.uploadedLocalFile_uploadDataTws !=
                                            null &&
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (selectedMedia != null &&
                                          ...
                                          try {
                                            ...
                                            _model.isDataUploading_uploadDataTws =
                                                false;
                                          }
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    _model.apiResult9zt =
                                        await AddVehicleCall.call(
                                      vehicleImage: _model
                                          .uploadedLocalFile_uploadDataTws,
                                      vehicleName:
                                          _model.vehicleNameTextController.text,
                                      kmperPrice:
                                          _model.priceperkmTextController.text,
                                      vehicleType:
                                          _model.vehicleTypeTextController.text,
                                      seatingCapacity: _model
                                          .seatingCapacityTextController.text,
                                      luggageCapacity: _model
                                          .luggageCapacityTextController.text,
                                      token: currentAuthenticationToken,
                                    );

                                    if ((_model.apiResult9zt?.succeeded ??
                                        true)) {
                                      await showDialog(
                                        context: context,
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: Text('Failed'),
                                            content: Text('Vehicle not added'),
                                            actions: [
                                              TextButton(
                                                onPressed: () => Navigator.pop(
                                                    alertDialogContext),
