                            ...
                            children: [
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    _model.apiResultmsc =
                                        await VerifyDocsCall.call(
                                      driverId: widget!.userId,
                                      verificarionSrarus: 'approved',
                                      token: currentAuthenticationToken,
                                    );

                                    if ((_model.apiResultmsc?.succeeded ??
                                        true)) {
                                      await showDialog(
                                        context: context,
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: Text('success'),
                                            content: Text('Driver kyc updated'),
                                            actions: [
                                              TextButton(
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: Text('Fail'),
                                            content: Text((_model.apiResultmsc
                                                        ?.jsonBody ??
                                                    '')
                                                .toString()),
                                            actions: [
