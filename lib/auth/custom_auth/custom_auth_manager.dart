...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    ugoAdminAuthUserSubject.add(
      UgoAdminAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<UgoAdminAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  UgoAdminAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = UgoAdminAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    ugoAdminAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
